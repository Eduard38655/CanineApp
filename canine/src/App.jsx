...
/*Cada vez que cambie dog se debe de ACTUALIZAR LOS VALORES guardar los valore*/
  ...
  return (
    <main className={Styles.Container}>
      <div className={Styles.Div_Selection}>
        <button onClick={() => { SetValid(true) }}>Ver todos los caninos</button>
        <button onClick={() => { SetValid(false) }}>Filtar por caninos</button>
      </div>
